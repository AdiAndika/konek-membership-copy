...
const handleInput = () => {
  errorMessage.value = '';
  // Jika nilai input dimulai dengan '0', hapus '0' tersebut
  if (phoneNumber.value.startsWith('0')) {
    phoneNumber.value = phoneNumber.value.slice(1);
  }
};
          ...
          <div class="w-full max-w-sm">
            ...
            <div class="relative">
              <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                ...
                <span class="ml-2 text-gray-700 font-semibold text-base">+62</span>
              </div>
              <input
                  v-model="phoneNumber"
                  @input="handleInput"
            ...
            <p class="mt-[1.618rem] text-sm text-gray-600">
              Belum Punya Akun?
              <button @click="showRegisterModal = true" type="button" class="font-bold text-blue-600 hover:underline">
                Daftar Gratis
              </button>
            </p>
          </div>
