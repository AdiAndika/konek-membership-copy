    ...
    <div class="container mx-auto max-w-lg p-4">
      ...
      <main class="text-center">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 text-left">
          ...
          <div class="space-y-3 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-medium text-gray-800">{{
                formatCurrency(invoice.payment.adminFee)
              }}</span>
            </div>
          </div>
        ...
        <div class="mt-8">
          <button
            @click="emit('download')"
            class="w-full bg-blue-500 text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center space-x-2 hover:bg-blue-600 transition-colors"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
